  ...
  return (
    <main className="bg-white dark:bg-gray-900">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <motion.div
              ...
              className="text-center lg:text-left order-2 lg:order-1 p-4 sm:p-0 bg-white/70 dark:bg-gray-900/50 rounded-xl backdrop-blur sm:bg-transparent sm:backdrop-blur-0"
            >
              <motion.h1
        ...
        {/* Scroll Indicator (hidden on mobile to declutter) */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
